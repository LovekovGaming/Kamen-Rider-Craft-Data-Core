advancement revoke @s only krc_core:na-go
function #krc_core:pre_check/na-go
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex2 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex3 run function #krc_core:first_henshin/na-go
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:na_go_rider_core_id"}] run scoreboard players set @s krc.form1n 0
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:fantasy_raise_buckle"}] run scoreboard players set @s krc.form2n 2
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:fantasy_raise_buckle"}] run scoreboard players set @s krc.form3n 2
...
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
scoreboard players operation Form_Difference krc.form3n -= @s krc.form3n
function #krc_core:post_check/na-go
