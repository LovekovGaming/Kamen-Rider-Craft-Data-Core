advancement revoke @s only krc_core:knuckle
function #krc_core:pre_check/knuckle
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/knuckle
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:basic_knuckle_core"}] run scoreboard players set @s krc.form2n 0
...
scoreboard players operation Form_Difference krc.form1n -= @s krc.form1n
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
function #krc_core:post_check/knuckle
