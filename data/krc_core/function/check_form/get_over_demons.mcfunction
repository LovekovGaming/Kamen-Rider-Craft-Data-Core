advancement revoke @s only krc_core:get_over_demons
function #krc_core:pre_check/get_over_demons
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/get_over_demons
...
scoreboard players operation Form_Difference krc.form4n -= @s krc.form4n
scoreboard players operation Form_Difference krc.form5n -= @s krc.form5n
function #krc_core:post_check/get_over_demons
