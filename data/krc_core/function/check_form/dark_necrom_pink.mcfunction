advancement revoke @s only krc_core:dark_necrom_pink
function #krc_core:pre_check/dark_necrom_pink
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/dark_necrom_pink

scoreboard players operation Form_Difference krc.form2n = @s krc.form2n
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:dark_necrom_pink_ghost_eyecon"}] run scoreboard players set @s krc.form2n 0
...
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
function #krc_core:post_check/dark_necrom_pink
