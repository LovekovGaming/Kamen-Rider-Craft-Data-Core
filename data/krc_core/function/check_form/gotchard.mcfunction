advancement revoke @s only krc_core:gotchard
function #krc_core:pre_check/gotchard
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/gotchard
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:x_assemble_ride_chemy_card"}] run scoreboard players set @s krc.form1n 52
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:gotchar_igniter"}] run scoreboard players set @s krc.form1n 53
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:gotchar_igniter_as"}] run scoreboard players set @s krc.form1n 54
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:gotchar_igniter_aw"}] run scoreboard players set @s krc.form1n 55
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:gotchar_igniter_em"}] run scoreboard players set @s krc.form1n 56
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:tenliner_ride_chemy_card"}] run scoreboard players set @s krc.form1n 57
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:crosshopper_ride_chemy_card"}] run scoreboard players set @s krc.form1n 58
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:nijigon_ride_chemy_card_extra"}] run scoreboard players set @s krc.form1n 59
