advancement revoke @s only krc_core:blades
function #krc_core:pre_check/blades
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/blades
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:tenkuu_no_pegasus_wonder_ride_book"}] run scoreboard players set @s krc.form1n 1
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:tri_cerberus_wonder_ride_book"}] run scoreboard players set @s krc.form1n 3
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:king_lion_daisenki_wonder_ride_book"}] run scoreboard players set @s krc.form1n 7
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:king_lion_daisenki_wonder_ride_book"}] run scoreboard players set @s krc.form1n 7
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:tategami_hyoujuu_senki_wonder_ride_book"}] run scoreboard players set @s krc.form1n 8
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:tategami_hyoujuu_senki_wonder_ride_book"}] run scoreboard players set @s krc.form1n 8
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:lion_senki_wonder_ride_book"}] run scoreboard players set @s krc.form2n 0
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:specter_gekikou_senki_wonder_ride_book"}] run scoreboard players set @s krc.form2n 1
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:peter_fantasista_wonder_ride_book"}] run scoreboard players set @s krc.form3n 1
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:saiyuu_journey_wonder_ride_book"}] run scoreboard players set @s krc.form3n 2
...
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
scoreboard players operation Form_Difference krc.form3n -= @s krc.form3n
function #krc_core:post_check/blades
