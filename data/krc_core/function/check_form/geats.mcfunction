advancement revoke @s only krc_core:geats
function #krc_core:pre_check/geats
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex2 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex3 run function #krc_core:first_henshin/geats
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:geats_rider_core_id"}] run scoreboard players set @s krc.form1n 0
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:geats_rider_core_id_osaka"}] run scoreboard players set @s krc.form1n 2
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:geats_rider_core_id_fukuoka"}] run scoreboard players set @s krc.form1n 3
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:geats_rider_core_id_nagoya"}] run scoreboard players set @s krc.form1n 4
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:geats_rider_core_id_tokyo"}] run scoreboard players set @s krc.form1n 5
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:command_twin_buckle_jet"}] run scoreboard players set @s krc.form2n 32
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:command_twin_buckle_cannon"}] run scoreboard players set @s krc.form2n 33
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:boost_mkii_raise_buckle"}] run scoreboard players set @s krc.form2n 34
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:unite_grip"}] run scoreboard players set @s krc.form2n 35
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:boost_mkiii_raise_buckle"}] run scoreboard players set @s krc.form2n 36
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:oneness_raise_buckle"}] run scoreboard players set @s krc.form2n 37
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:command_twin_buckle_jet"}] run scoreboard players set @s krc.form3n 32
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:command_twin_buckle_cannon_l"}] run scoreboard players set @s krc.form3n 33
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:boost_mkii_raise_buckle"}] run scoreboard players set @s krc.form3n 35
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:boost_mkiii_raise_buckle"}] run scoreboard players set @s krc.form3n 36
...
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
scoreboard players operation Form_Difference krc.form3n -= @s krc.form3n
function #krc_core:post_check/geats
