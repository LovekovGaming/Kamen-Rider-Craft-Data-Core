advancement revoke @s only krc_core:demons
function #krc_core:pre_check/demons
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/demons
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:spider_vistamp"}] run scoreboard players set @s krc.form1n 0
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:giant_spider_vistamp"}] run scoreboard players set @s krc.form1n 1
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:komodo_vistamp_demons"}] run scoreboard players set @s krc.form2n 1
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:crocodile_vistamp_demons"}] run scoreboard players set @s krc.form3n 1
...
scoreboard players operation Form_Difference krc.form4n -= @s krc.form4n
scoreboard players operation Form_Difference krc.form5n -= @s krc.form5n
function #krc_core:post_check/demons
