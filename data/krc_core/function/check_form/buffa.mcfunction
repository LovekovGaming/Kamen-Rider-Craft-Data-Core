advancement revoke @s only krc_core:buffa
function #krc_core:pre_check/buffa
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex2 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex3 run function #krc_core:first_henshin/buffa
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:buffa_rider_core_id"}] run scoreboard players set @s krc.form1n 0
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:buffa_rider_core_id_cracked"}] run scoreboard players set @s krc.form1n 2
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:jyamashin_wish_card"}] run scoreboard players set @s krc.form1n 3
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:jyamato_buckle_buffa"}] run scoreboard players set @s krc.form2n 31
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:jyamato_buckle_buffa"}] run scoreboard players set @s krc.form3n 31
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:plosion_rage_raise_buckle"}] run scoreboard players set @s krc.form3n 38
...
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
scoreboard players operation Form_Difference krc.form3n -= @s krc.form3n
function #krc_core:post_check/buffa
