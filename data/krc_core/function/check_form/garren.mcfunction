advancement revoke @s only krc_core:garren
function #krc_core:pre_check/garren
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/garren
