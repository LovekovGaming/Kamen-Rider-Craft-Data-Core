advancement revoke @s only krc_core:neo_decade
function #krc_core:pre_check/neo_decade
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/neo_decade
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:w_card"}] run scoreboard players set @s krc.form1n 59
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:ooo_card"}] run scoreboard players set @s krc.form1n 60
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:fourze_card"}] run scoreboard players set @s krc.form1n 61
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:wizard_card"}] run scoreboard players set @s krc.form1n 62
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:gaim_card"}] run scoreboard players set @s krc.form1n 63
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:drive_card"}] run scoreboard players set @s krc.form1n 64
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:ghost_card"}] run scoreboard players set @s krc.form1n 65
