advancement revoke @s only krc_core:dark_decade
function #krc_core:pre_check/dark_decade
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/dark_decade

scoreboard players operation Form_Difference krc.form1n = @s krc.form1n
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:dark_decade_card"}] run scoreboard players set @s krc.form1n 0
...
scoreboard players operation Form_Difference krc.form1n -= @s krc.form1n
function #krc_core:post_check/dark_decade
