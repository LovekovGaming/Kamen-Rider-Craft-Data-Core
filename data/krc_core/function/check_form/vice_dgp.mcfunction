advancement revoke @s only krc_core:vice_dgp
function #krc_core:pre_check/vice_dgp
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex2 unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex3 run function #krc_core:first_henshin/vice_dgp
...
execute unless items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"providence_card"}] run scoreboard players set @s krc.form1n 0
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:revice_driver_raise_buckle_vice"}] run scoreboard players set @s krc.form2n 40
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex3:"kamenridercraft:revice_driver_raise_buckle_vice"}] run scoreboard players set @s krc.form3n 39
...
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
scoreboard players operation Form_Difference krc.form3n -= @s krc.form3n
function #krc_core:post_check/vice_dgp
