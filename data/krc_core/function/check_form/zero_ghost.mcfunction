advancement revoke @s only krc_core:zero_ghost
function #krc_core:pre_check/zero_ghost
execute unless data entity @s Inventory[{Slot:100b}].components.minecraft:custom_data.slot_tex1 run function #krc_core:first_henshin/zero_ghost

scoreboard players operation Form_Difference krc.form2n = @s krc.form2n
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex2:"kamenridercraft:proto_ore_damashii"}] run scoreboard players set @s krc.form2n 0
...
scoreboard players operation Form_Difference krc.form2n -= @s krc.form2n
function #krc_core:post_check/zero_ghost
